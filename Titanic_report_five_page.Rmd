...
```{r "Age distribution by survival", echo=FALSE, fig.width=2, message=FALSE, warning=FALSE, paged.print=FALSE}
library(ggplot2)
...
```{r echo=FALSE, fig.width=2, out.width='60%'}
...
```{r "Age distribution", echo=FALSE, fig.width=2, message=FALSE, warning=FALSE, paged.print=FALSE}
library(ggplot2)
theme_set(theme_classic())
...
```{r "SibSp distribution", echo=FALSE, fig.width=2, message=FALSE, warning=FALSE, paged.print=FALSE}
...
```{r "Parch distribution", echo=FALSE, fig.width=2, message=FALSE, warning=FALSE, paged.print=FALSE}
...
```{r "Fare distribution", echo=FALSE, fig.width=2}
